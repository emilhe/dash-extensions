...
- Remap of callback bindings in `DashProxy` to enable callback registration via the `before_first_request` hook (need for compability with the latest `pages` implementation)
